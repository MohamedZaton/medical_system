...
import 'nursing_services_list_logic.dart';

class NursingServicesListPage extends StatelessWidget {
  final logic = Get.put(NursingServicesListLogic());
  static const String id = "/nursing_services_list_page";
